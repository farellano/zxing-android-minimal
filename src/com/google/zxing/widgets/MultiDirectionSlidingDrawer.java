...
public class MultiDirectionSlidingDrawer extends ViewGroup implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (slidingMenuListener != null){
            slidingMenuListener.onSlidingMenuOptionSelected(isEmpty((String) v.getTag()) ? "" : (String)v.getTag());
        }
    }
    ...
    protected void onFinishInflate()
    {
        ...
        LayoutParams params = mHandle.getLayoutParams();
